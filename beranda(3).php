...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="beranda(3).php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
  <ul>
  <?php
    if($r['id_level'] == 3){
  ?>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="beranda(3).php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Beranda</a></div>
  </div>
<!--End-breadcrumbs-->
