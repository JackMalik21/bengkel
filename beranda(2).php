...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="beranda(2).php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
  <ul>
  <?php
    if($r['id_level'] == 2){
  ?>
    <li class="active"><a href="beranda(2).php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li> <a href="entri_transaksi(2).php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="beranda(2).php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Beranda</a></div>
  </div>
<!--End-breadcrumbs-->
