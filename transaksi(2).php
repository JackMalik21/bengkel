...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_transaksi(3).php">Transaksi</a></h1>
</div>
<!--close-Header-part-->
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_transaksi(2).php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a>
  <ul>
    <li> <a href="widgets.html"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb">
      <a href="entri_transaksi(2).php" title="Enttri Transaksi" class="tip-bottom"><i class="icon icon-inbox"></i>
        Entri Transaksi
      </a>
      <a href="transaksi(2).php" title="Transaksi" class="tip-bottom"><i class="icon icon-ok"></i>
        Transaksi
      </a>
    </div>
  </div>
      ...
      <div class="span7">
        <div class="widget-box">
          <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
            <h5>Transaksi Pemesanan (<?php echo $result_pemesan['nama_user'];?>)</h5>
          </div>
      ...
      <?php
          if(isset($_REQUEST['back_order'])){
            if(isset($_SESSION['edit_order'])){
              ...
              header('location: entri_transaksi(2).php');
            }
          }
        }
      ?>
