...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="beranda(4).php" class="visible-phone"><i class="icon icon-home"></i> Beranda</a>
  <ul>
  <?php
    if($r['id_level'] == 4){
  ?>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="beranda(4).php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Beranda</a></div>
  </div>
<!--End-breadcrumbs-->
