...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_transaksi(2).php">Entri Transaksi</a></h1>
</div>
<!--close-Header-part-->
...
<div id="sidebar"><a href="entri_transaksi(2).php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a>
  <ul>
    ...
    if($r['id_level'] == 2){
    ?>
    <li> <a href="beranda(2).php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="entri_transaksi(2).php"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_transaksi(2).php" title="Go to here" class="tip-bottom"><i class="icon icon-inbox"></i> Entri Transaksi</a></div>
  </div>
<!--End-breadcrumbs-->
              ...
              <tbody>
                ...
                <?php
                  ...
                  if(isset($_REQUEST['edit_order'])){
                    ...
                    header('location: transaksi(2).php');
                  }
                ?>
                </tbody>
                </table>
