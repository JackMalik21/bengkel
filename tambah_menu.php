        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
                <?php
                  if(isset($_SESSION['edit_menu'])){
                ?>
                  <input name="" type="Nama Masakan" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Masakan" disabled="" required/>
                  <input name="nama_masakan" type="hidden" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Masakan" />
                <?php
                  } else {
                ?>
                  <input name="nama_masakan" type="Nama Masakan" value="" class="span11" placeholder="Nama Masakan" required/>
                <?php
                  }
                ?>
              </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="harga" type="Rupiah" value="<?php echo $harga; ?>" class="span11" placeholder="Rupiah" required >
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Stok Persediaan :</label>
              <div class="controls">
                <input name="stok" value="<?php echo $stok; ?>" type="number" class="span11" placeholder="Jumlah Stok" required/>
              </div>
            </div>
            <div class="control-group">
