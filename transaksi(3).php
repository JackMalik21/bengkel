...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_transaksi(3).php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Entri Transaksi</span></a>
  <ul>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb">
      <a href="entri_transaksi(3).php" title="Enttri Transaksi" class="tip-bottom"><i class="icon icon-inbox"></i>
        Entri Transaksi
      </a>
      <a href="transaksi(3).php" title="Transaksi" class="tip-bottom"><i class="icon icon-ok"></i>
        Transaksi
      </a>
    </div>
  </div>
      ...
      <?php
          if(isset($_REQUEST['back_order'])){
            if(isset($_SESSION['edit_order'])){
              ...
              header('location: entri_transaksi(3).php');
            }
          }
